...
## Informasi Umum
- **Nama Browser** :  netsurf
- **Versi Browser** :  147.0.3
...
| Aktivitas | Hasil |
|---------|------|
| Startup browser | Sedang |
| Membuka tab baru | Cepat |
| Scrolling halaman berat | Sedikit lag |
...
browser dengan tampilan modern namun penggunaan ram yang tinggi
